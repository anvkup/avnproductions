            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="mt-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p><strong>Q: Can I collaborate with AVN Productions?</strong><br />A: Absolutely! We are always open to collaborations. Please reach out to us through the contact form or email.</p>
                ...
                <div className="text-center mt-6">
                    <p>Thank you for your interest in AVN Productions! We look forward to connecting with you.</p>
                </div>
            </div>
            <Footer />
        </div>
