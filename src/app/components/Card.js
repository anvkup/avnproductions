                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                            About AVN Productions
                        </h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">
                            At AVN Productions, we are passionate about crafting music that resonates with the soul. Our goal is to inspire, innovate, and push the boundaries of sound, delivering music that is fresh, authentic, and moving.
                        </p>
                    </div>
