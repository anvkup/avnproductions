    ...
    return (
        <div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-10">
                ...
                <p className="mb-4">
                    Welcome to AVN Music! This privacy policy explains how we collect, use, and share your personal information when you visit our website <a href="https://avnmusic.site" className="text-blue-500 hover:underline">avnmusic.site</a>.
                </p>
